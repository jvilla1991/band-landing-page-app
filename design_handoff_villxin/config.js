...
window.SITE = {
  ...
  /* ---- YOURAREA (community — NON-API / static demo data) ----
     The fan space. Real app: forum + DM backend; this is the design mock. */
  yourarea: {
    name: "YourArea",
    tag: "a villxin space",
    memberCount: 47,
    ...
    profile: {
      ...
      mood: "smoldering",
      song: { title: "Ashfall", note: "profile song · demo", duration: "3:48" },
    },
    blurb: {
      about: "This is the official villxin profile. Bulletins, demos and pre-release things land here first. Leave a comment, claim a corner, be kind to each other.",
